// Add SVG Bar Chart (Adjacent Bars with Variance)
// Creates an SVG measure for bar chart with actual, target, and variance bars
...
var measureName = "SVG Bar Chart (Adjacent Target and Variance)";  // Name of the SVG measure
