// Add SVG Bullet Chart with Label
// Creates an SVG measure for bullet chart visualization with variance label
...
var measureName = "SVG Bullet Chart (with Label)";  // Name of the SVG measure
...
Info("Created SVG Measure\n" +
     ...
     "4. Adjust colors/formatting in the DAX as needed");
